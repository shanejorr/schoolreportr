...
```{r loadData, results = 'hide', include = FALSE, cache = TRUE}
...
```{r citiesTable, include = FALSE, results = 'hide', cache = TRUE}
...
all_race_population <- schoolreportr:::acs_tracts_race(census_demographics, races_to_use)

schoolreportr:::choropath_tracts_race(
  all_race_population, 'Black / African-American', tracts_in_district[["shapefiles_tracts_in_district"]], 
  district_shapefile$geometry, school_directory
)
```
...
```{r}
schoolreportr:::choropath_tracts_race(
  all_race_population, 'Hispanic / Latinx', tracts_in_district[["shapefiles_tracts_in_district"]], 
  district_shapefile$geometry, school_directory
)
```
...
```{r}
schoolreportr:::choropath_tracts_race(
  all_race_population, 'White', tracts_in_district[["shapefiles_tracts_in_district"]], 
  district_shapefile$geometry, school_directory
)
```
