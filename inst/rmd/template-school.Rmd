...
census_demographics <- sr_demographic_data(names(race_popualtion_variables), state_abb, geoid_tracts_in_district)   |>
    dplyr::mutate(variable = recode(variable, !!!race_popualtion_variables))
...
census_education <- sr_rmd_get_educational_attainment(state_abb, tracts_in_district$GEOID)
