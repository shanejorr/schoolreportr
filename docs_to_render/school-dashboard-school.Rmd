...
labels <- glue::glue(
  "<strong>{race_var} Population</strong><br/>
   <strong>{black_population$estimate}</strong> {race_var} residents (+/- {black_population$moe})<br/>
   <strong>{black_population$perc_estimate}</strong> {race_var} population (+/- {black_population$perc_moe})"
  ) %>%
